...
Dicey is available for a one-time upfront purchase on the Apple App Store. Apple handles this transaction entirely. We do not have access to your payment information, credit card details, or Apple ID. Please refer to Apple’s official Privacy Policy for information on how they handle your purchase data.
...
If we ever update Dicey to include features that require data collection (such as iCloud syncing for your saved comparison snapshots), we will update this Privacy Policy accordingly and ensure that any changes are fully compliant with privacy laws.

## 6. Contact

If you have any questions or concerns about this Privacy Policy or how Dicey handles your data, please contact the developer via the app's official GitHub repository or App Store support page.
